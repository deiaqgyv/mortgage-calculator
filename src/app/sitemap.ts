...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const articles = ['amortization', 'extra-payments', 'affordability', 'amortization-calculator', 'extra-payment-calculator', 'methodology', 'editorial-policy', 'corrections-policy', 'legal-notice', 'privacy'];
